...
draft report and a key terms panel. The export to a draft report functionality would be useful as the lawyer's deliverable after reviewing the documents is a report, so being able to export important parts of the chat would expedite that process. The key terms panel would be helpful as it immediately summarises the documents for a lawyer and draws their attention to the main points of the document. I'd also add optical character recognition (OCR) to deal with scanned documents as scanned documents are
